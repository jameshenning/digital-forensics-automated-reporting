...
pub const AI_OSINT_PERSON_CALLED: &str = "AI_OSINT_PERSON_CALLED";
pub const AI_OSINT_BUSINESS_CALLED: &str = "AI_OSINT_BUSINESS_CALLED";
pub const OSINT_CONSENT_ACKNOWLEDGED: &str = "OSINT_CONSENT_ACKNOWLEDGED";
